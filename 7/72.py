...
def create_default_dict ():
    ...
    for c in ['A', 'K', 'Q', 'T', '9', '8', '7', '6', '5', '4', '3', '2', 'J']:
        d[c] = 0;
...
def eval_hand (hand):
    ...
    for card in hand:
        ...
        if card == 'bid' or card == 'str' or card == 'J':
            # not an actual card or a joker
            continue
    ...
    if ((of_a_kind_5 == 1) or                            # 5-of-a-kind
        (of_a_kind_4 == 1 and num_jokers == 1) or
        (of_a_kind_3 == 1 and num_jokers == 2) or
        (of_a_kind_2 == 1 and num_jokers == 3) or
        (num_jokers >= 4)
        ):

        return 7

    if ((of_a_kind_4 == 1) or                            # 4-of-a-kind
        (of_a_kind_3 == 1 and num_jokers == 1) or
        (of_a_kind_2 == 1 and num_jokers == 2) or
        (num_jokers == 3)
        ):
        return 6

    if ((of_a_kind_3 == 1 and of_a_kind_2 == 1) or        # full house
        (of_a_kind_2 == 2 and num_jokers == 1)
        ):
        return 5

    if ((of_a_kind_3 > 0) or                            # 3-of-a-kind
        (of_a_kind_2 >= 1 and num_jokers >= 1) or
        (num_jokers == 2) 
        ):
        return 4

    if ((of_a_kind_2 > 1) or                            # 2 pairs
        (of_a_kind_2 == 1 and num_jokers >= 1)
        ):
        return 3

    if ((of_a_kind_2 > 0) or                            # a pair
        (num_jokers >= 1)
        ):
        return 2
